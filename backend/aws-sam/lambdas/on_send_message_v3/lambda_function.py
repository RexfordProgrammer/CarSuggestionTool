...
from dynamo_db_helpers import save_user_message,save_bot_response, get_user_preferences
...
def lambda_handler(event, context):
    ...
    if ("hold on" in conversational_response.lower()):
        push_message_to_caller(connection_id,apigw, get_user_preferences(connection_id))
